...
const createPodcast = async (req, res) => {
  try {
    ...
    const prompt = `Generate a short and engaging podcast conversation between two hosts discussing legal aid topics. 
    Host1 speaks like ${voice1}, Host2 speaks like ${voice2}. 
    Start with "Hey, welcome to the Predictive Legal Aid Podcast" and then introduce the 
    Topic: "${topic}". 
    Include practical legal tips, relevant resources, and common legal scenarios. 
    Mark lines with 'Host1:' or 'Host2:'. 
